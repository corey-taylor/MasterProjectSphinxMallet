...
public class LargeNGramModel implements LanguageModel, BackoffLanguageModel {
    ...
    // Working data
    // --------------------------------
    protected Map<Word, UnigramProbability> unigramIDMap;
    ...
    */
     ...
     */
    public float getBigramProb(int word1, int word2) {
        NGramBuffer bigram = getBigramBuffer(word1);
        NGramProbability bigramProbability = bigram.
        		findNGram(word2);
